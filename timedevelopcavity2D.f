...
C********* ********* ********* ********* ********* ********* *********C
C
C     PROGRAM timedevelopcavity2D.f
C
C     Program for 2D cavity flow by FDM
...
C
 ...
 110    CONTINUE
        IF(DVMAX.LT.1.D-10) GOTO 1000
 100  CONTINUE
 1000 IF(MOD(IT,1000).EQ.0) THEN
        WRITE(6,*) ITER,DVMAX
      ENDIF
      DO 120 J=1,NY
      DO 120 I=1,NX-1
